...
const Cookies = () => (
    <PageLoading>
        <h1>Cookie Policy for FriendyFy</h1>

        <p>This is the Cookie Policy for FriendyFy, accessible from friendyfy.com</p>
        ...
        <ul>
            ...
            <li>
                <p>We also use social media buttons and/or plugins on this site that allow you to connect with your social network in various ways. It will set cookies through our site which may be used to enhance your profile on their site or contribute to the data they hold for various purposes outlined in their respective privacy policies.</p>
            </li>
